...
#define CBLK_OPN_GROUP         0x100  /* Use cblk_cg_open()             */

/************************************************************************/
/* Common flag for non-open APIs                                        */
/************************************************************************/
#define CBLK_GROUP_ID           0x100 /* id passed is a chunk group id  */
#define CBLK_GROUP_RAID0        0x200 /* id passed is a RAID0 group id  */
#define CBLK_GROUP_MASK         (CBLK_GROUP_ID|CBLK_GROUP_RAID0)
