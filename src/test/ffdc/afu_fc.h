...
#define FC_PORT0_OFFSET 0x2012000
#define FC_PORT1_OFFSET 0x2013000

// FC module register offset (byte address)
// perl -ne 'if( /localparam\s+(\S+)\s*=\s*12.h([0-9a-f]+)/i ) { print "#define $1 0x$2\n";}' fc_module/src/ctms_fc_regs.v
